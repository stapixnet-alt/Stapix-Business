...
public class BuyBusinessCommand implements CommandExecutor {
    ...
    public BuyBusinessCommand(StapixBusiness plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (business.getHoloWorld() != null && !business.getHoloWorld().isEmpty()) {
            ...
            if (world != null && player.getWorld().equals(world)) {
                org.bukkit.Location holoLoc = new org.bukkit.Location(world,
                    business.getHoloX(), business.getHoloY(), business.getHoloZ());
