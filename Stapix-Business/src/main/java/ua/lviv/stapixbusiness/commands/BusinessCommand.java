...
import ua.lviv.stapixbusiness.gui.BusinessOwnerGUI;
...
public class BusinessCommand implements CommandExecutor {
    ...
    public BusinessCommand(StapixBusiness plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            player.sendMessage("§7Використайте: §e/bs <id> §7для управління");
            return true;
        }
